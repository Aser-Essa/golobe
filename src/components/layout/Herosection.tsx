export default function Herosection() {
  return (
    <div className="relative">
      ...
      <div className="absolute right-0 left-0 flex flex-col items-center justify-center gap-3 px-4 text-center text-white max-md:top-1/2 max-md:-translate-y-1/2 md:top-35 md:gap-5">
